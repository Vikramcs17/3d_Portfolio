...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "vikramgupta1704@gmail",
    href: "mailto:vikramgupta1704@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/vikram-gupta-165152301/",
    content: "/vikram-gupta",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/vikramcs17",
    content: "vikramcs17",
        ...
        <aside className="w-full md:basis-1/4">
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              <div className="flex justify-center items-center lg:w-full lg:aspect-square bg-zinc-800 rounded-full lg:mb-5">
                <img
                  className="rounded-full w-[200px] md:w-[300px] lg:w-[400px] aspect-square  bg-zinc-800"
                  alt="me"
                  src="/assets/vikram.jpg"
                />
              </div>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Vikram Gupta, Motivated Computer Science student with hands-on experience in frontend development, a strong
understanding of coding fundamentals, and a passion for building clean, scalable web applications. Eager to
contribute to real-world projects, collaborate with teams, and continuously grow in the field of software
development..
            </p>
            <p className="mb-10">
